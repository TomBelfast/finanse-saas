...
>(({ defaultOpen = true, open: openProp, onOpenChange, className, style, children, ...props }, ref) => {
  ...
  // This is a simple implementation, you can use a media query hook for more accuracy
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn("group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]/sidebar-wrapper:bg-sidebar", className)}
          ref={ref}
          {...props}
        >
          {children}
    ...
    >
      ...
      <div
        className={cn(
          ...
          state === "collapsed" && collapsible === "icon" && "group-data-[variant=floating]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
        )}
        aria-hidden="true"
      />
      <div
        className={cn(
          ...
          // Adjust the padding when collapsed to icon
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
        >
          {children}
        </div>
      </div>
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "has-[[data-variant=inset]]/sidebar-wrapper:bg-sidebar",
          className
        )}
        {...props}
      />
...
>(({ asChild = false, isActive = false, tooltip, className, ...props }, ref) => {
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebarMenuButtonVariants({ size: "default" }), className)}
      {...props}
    />
  )
