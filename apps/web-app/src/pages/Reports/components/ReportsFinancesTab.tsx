  ...
  if (subscriptions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center space-y-4">
        ...
        <div>
          <h3 className="text-lg font-medium text-foreground">Brak subskrypcji</h3>
          <p className="text-sm text-muted-foreground max-w-xs mx-auto">Dodaj pierwszą subskrypcję w sekcji Finanse, aby zobaczyć analizę.</p>
        </div>
      </div>
    );
  }
  ...
  if (!chartData) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center space-y-4">
        ...
        <div>
          <h3 className="text-lg font-medium text-foreground">Brak danych finansowych</h3>
          <p className="text-sm text-muted-foreground max-w-xs mx-auto">Dodaj kwoty do swoich subskrypcji, aby zobaczyć je na wykresie.</p>
        </div>
      </div>
    );
  }
      ...
      <Card className="shadow-sm border-border/50">
        <CardHeader className="border-b border-border/50 pb-4">
          <CardTitle className="flex items-center gap-2">
            ...
            <span className="text-lg">Analiza wydatków (Subskrypcje)</span>
          </CardTitle>
        </CardHeader>
